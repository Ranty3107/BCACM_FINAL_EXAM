...
const epreuvesParDefaut = {
    "sujet type i : informatique / intégration web": {
        desc: "Type I : Évaluation sur l'intégration des technologies modernes et les concepts web fondamentaux.",
        questions: [
    ...
    "sujet type ii : informatique / intégration web": {
        desc: "Type II : Évaluation sur l'intégration des technologies modernes et les concepts web fondamentaux.",
        questions: [
...
function lancerExamenParMatiere(cleMatiere) {
    ...
    document.getElementById('examSidebarDynamic').innerHTML = `
        ...
        <div class="help-item">
            ...
            <div class="help-item">
                ...
                <pre>text-align: center;<br>font-weight: bold;<br>font-style: italic;<br>background-color: #XXXXXX;<br>padding: 10px;</pre>
    </div>
    ...
    <div class="help-item">
        ...
        <p>Utilisez Flexbox sur le conteneur parent :</p>
        <pre>display: flex;<br>gap: 20px;</pre>
    </div>

    <div class="help-item">
        <strong>Le mot en bas de texte <br>
